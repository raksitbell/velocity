    ...
    <div class="bg-notion-bg text-zinc-300 min-h-screen flex flex-col antialiased selection:bg-blue-500/30 font-sans">
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="h-64 w-full relative group">
                @if (proj.cover_image) {
                <img [src]="proj.cover_image" class="w-full h-full object-cover">
                } @else {
                <div class="w-full h-full bg-gradient-to-r from-zinc-800 to-zinc-900 flex items-center justify-center">
            ...
            <div class="max-w-4xl mx-auto px-6 sm:px-12 -mt-12 relative z-10 pb-20">
                ...
                <!-- Title & Actions -->
                <div class="mb-8">
                    <h1 class="text-4xl md:text-5xl font-bold text-zinc-100 tracking-tight mb-4">{{ proj.title }}</h1>
                ...
                <div class="prose prose-invert prose-zinc max-w-none mb-12">
                    ...
                    <p class="text-zinc-400 leading-relaxed whitespace-pre-wrap">{{ proj.description || 'No description provided.' }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div class="bg-zinc-800/50 border border-zinc-800 rounded-lg p-4">
                            ...
                            <p class="text-zinc-400 text-sm">{{ proj.created_at | date:'mediumDate' }}</p>
                        </div>
                         <div class="bg-zinc-800/50 border border-zinc-800 rounded-lg p-4">
                            <h4 class="text-sm font-medium text-zinc-300 mb-2 flex items-center gap-2">
                ...
                <div class="mt-8">
                    ...
                    <app-board [projectId]="proj.id"></app-board>
                </div>
