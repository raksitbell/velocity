      ...
      <main className="min-h-screen bg-[#020510] text-white font-sans overflow-x-hidden">
        ...
        <nav className="sticky top-0 z-30 border-b border-white/5 backdrop-blur-xl bg-[#020510]/80">
          <div className="max-w-6xl mx-auto px-5 sm:px-8 h-14 flex items-center justify-between gap-4">
            ...
            <div className="hidden sm:flex items-center gap-6 text-sm text-zinc-400">
              ...
              <Link href="/simulator" className="px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold rounded-lg text-xs uppercase tracking-wider transition-colors shadow-[0_0_16px_rgba(6,182,212,0.3)]">
                Launch →
              </Link>
            </div>
          ...
          {menuOpen && (
            <div className="sm:hidden border-t border-white/5 px-5 py-4 flex flex-col gap-3 bg-[#020510]">
              ...
              <Link href="/simulator" className="mt-1 py-3 bg-cyan-600 text-white font-bold rounded-xl text-sm uppercase tracking-widest text-center transition-colors hover:bg-cyan-500">
                🚀 Launch Simulator
              </Link>
            </div>
          )}
        ...
        <section className="relative z-10 text-center px-5 pt-20 pb-20 sm:pt-28 sm:pb-24 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/simulator" className="w-full sm:w-auto px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-xl transition-all shadow-[0_0_30px_rgba(6,182,212,0.4)] text-sm uppercase tracking-widest text-center">
              🚀 Launch Simulator
            </Link>
        ...
        <section className="relative z-10 px-5 sm:px-8 py-20 sm:py-24">
          <div className="relative max-w-xl mx-auto">
            ...
            <div className="relative border border-cyan-500/20 bg-white/[0.03] backdrop-blur-2xl rounded-3xl px-8 sm:px-14 py-12 sm:py-14 text-center">
              ...
              <Link href="/simulator" className="inline-flex items-center gap-2 px-8 sm:px-10 py-4 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-xl transition-all shadow-[0_0_40px_rgba(6,182,212,0.35)] text-sm uppercase tracking-widest">
                🚀 Launch Simulator
              </Link>
            </div>
          </div>
